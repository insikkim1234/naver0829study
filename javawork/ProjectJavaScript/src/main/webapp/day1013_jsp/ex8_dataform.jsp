		...
		<table class="table table-bordered" style="width:400px;">
			...
			<tr>
				...
				<td class="input-group">
					...
					<input type="text" class="form-control" name="jsp" >
			...
			<tr>
				...
				<td class="input-group">
					<b>글자색</b>&nbsp;
					<input type="color" value="#0000ff" name="tcolor" class="form-control">
					&nbsp;&nbsp;
					<b>배경색</b>&nbsp;
					<input type="color" value="#ff77ff" name="bcolor" class="form-control">
				</td>	
			</tr>
			<tr>
